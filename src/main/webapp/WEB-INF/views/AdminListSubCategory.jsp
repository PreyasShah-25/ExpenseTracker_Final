										...
										<tbody>
											<c:forEach items="${scList}" var ="s">
														<tr>
																<td>${s[2]}</td>
																<td>${s[4]}</td>
																<td><a href="adminviewsubcategory?subCategoryId=${s[0]}"><i class="bi bi-binoculars"></i>View</a>|
																<a href="admindeletesubcategory?subCategoryId=${s[0]}"><i class="bi bi-trash3"></i>Delete</a>|
																<a  href ="admineditsubcategory?subCategoryId=${s[0] }"><i class="bi bi-pencil-square"></i>Edit</a></td>
														</tr>											
											</c:forEach>
										</tbody>					
			</table>
