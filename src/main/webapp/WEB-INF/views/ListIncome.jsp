							...
							<tbody>
										<c:forEach items="${incomeList}" var="i">
											...
											<tr>
												...
												<td>${i[6]}</td>
												<td>${i[3]}</td>
												<td><a href="viewincome?incomeId=${i[0]}"><i class="bi bi-binoculars"></i>View</a>|
												<a href="deleteincome?incomeId=${i[0]}"><i class="bi bi-trash3"></i>Delete</a>|
												<a href="editincome?incomeId=${i[0]}"><i class="bi bi-pencil-square"></i>Edit</a></td>
											</tr>
										</c:forEach>
							</tbody>
