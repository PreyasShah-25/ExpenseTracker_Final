								...
								<tbody>
										...
										<c:forEach items="${expenseList}" var="e">
												<tr>
														...
														<td> ${e[9]}</td>
														<td> ${e[2]}</td>
														<td><a href="viewexpense?expenseId=${e[0]}"><i class="bi bi-binoculars"></i>View</a>|
														<a href="deleteexpense?expenseId=${e[0]}"><i class="bi bi-trash3"></i>Delete</a>|
														<a href="editexpense?expenseId=${e[0]}"><i class="bi bi-pencil-square"></i>Edit</a>
														</td>
												</tr>
										</c:forEach>
								</tbody>
