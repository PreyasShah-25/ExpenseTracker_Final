                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Update Account Form -->
                            <form action="adminupdateexpense" method="post" id="editExpenseForm">
                                <div class="mb-3">
                                	...
                                	<label for="accountId" class="form-label">Select Account</label>
                                        <select  class="form-select" id="accountId" name="accountId" required>
									        ...
									        <c:forEach items = "${allAccount}" var = "account">
									        	<option value="${ account.accountId}"  ${account.accountId == expense.accountId? "selected":"" }>${account.title}</option>        
									        </c:forEach>
									        </select><br>
                                	</div>
                                	 <div class = "mb-3">
