...
<body>
								...
								<tbody>
										...
										<c:forEach items="${expenseList}" var="e">
												...
												<tr>
														...
														<td> ${e.description}</td>
														<td><a href="adminviewexpense?expenseId=${e.expenseId}"><i class="bi bi-binoculars"></i>View</a>|
														<a href="admindeleteexpense?expenseId=${e.expenseId}"><i class="bi bi-trash3"></i>Delete</a>|
														<a href="admineditexpense?expenseId=${e.expenseId}"><i class="bi bi-pencil-square"></i>Edit</a></td>
												</tr>
										</c:forEach>
								</tbody>
	...
	$( document ).ready(function() {
		let table = new DataTable('#myExpense');
	});
	</script>
