										...
										<tbody>
												<c:forEach   items= "${accountList}" var ="m">
															<tr>	
																	...
																	<td>${m[1]}</td>
																	<td>${m[2]}</td>
																	<td><a href="viewaccount?accountId=${m[0]}"><i class="bi bi-binoculars"></i>View</a>|<a
																	href="deleteaccount?accountId=${m[0]}"><i class="bi bi-trash3"></i>Delete</a>
																	|<a href ="editaccount?accountId=${m[0]}"><i class="bi bi-pencil-square"></i>Edit</a>       </td>
															</tr>
												</c:forEach>
										</tbody>
			</table>
