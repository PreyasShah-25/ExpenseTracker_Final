...
<body>
					...
					<div class="row" >
						...
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body">
									<h5 class="card-title">
										View<span>/Income</span>
									</h5>
									
									
									<table class="table datatable datatable-table table-hover" id="viewIncome">
   ...
   -->
	...
	$( document ).ready(function() {
		let table = new DataTable('#viewIncome');
	});
	</script>
